	...
	<div class="grid items-center gap-10 md:grid-cols-2">
		<div class="flex flex-col gap-4">
			...
			<p class="max-w-prose text-chalk/70">
				...
				staffs the agents that run it after that. You never explain your business from
				scratch again.
			</p>
			<p class="max-w-prose text-chalk/70">
				And it stays yours — your data powers your tools, nothing else, and leaves when you do.
			</p>
			<a
				href="/vision"
		...
		<div class="flex flex-col gap-3 rounded-2xl border border-hairline bg-carriage p-8">
			...
			<ul class="flex flex-col gap-3">
				<li class="flex items-center gap-3 text-sm text-chalk/80">
					...
					You describe how the business runs — once
				</li>
				<li class="flex items-center gap-3 text-sm text-chalk/80">

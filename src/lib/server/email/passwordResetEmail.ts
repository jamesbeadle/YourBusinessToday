export const passwordResetEmailSubject = 'Set a new password for Your Business Today';

export function renderPasswordResetEmail(setPasswordUrl: string): string {
	return `
<div style="margin:0;padding:32px 16px;background-color:#0b0e16;font-family:Arial,Helvetica,sans-serif;">
	<div style="max-width:520px;margin:0 auto;background-color:#141927;border:1px solid #242c40;border-radius:16px;padding:32px;">
		...
		<h1 style="margin:0 0 12px;font-size:22px;color:#eef1f8;">Set a new password</h1>
		<p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#c9d2e6;">
			We have sent you this link so you can get back into your account. Open it, choose a
			new password, and you will be signed in. If you were not expecting this, you can
			ignore it — nothing changes until the link is used.
		</p>
		<a
			href="${setPasswordUrl}"
